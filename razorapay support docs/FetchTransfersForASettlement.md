...
```bash: CLI
razorpay route transfers fetch-by-settlement --settlement-id setlod_JMNiqyuoFoJcXb
```
...
Descriptions for the optional query parameters are present in the [Pagination & Rate Limiting](https://razorpay.com/docs/build/llm-docs/api/understand.md#pagination) documentation.
