...
```bash: CLI
razorpay route accounts fetch acc_IEIkSOM5VJb2Lm
```
...
: `object` The account holder's business details.
    ...
    `category`
    : `string` The business category of the account holder. For example, `healthcare`. Possible values: [Business Category](https://razorpay.com/docs/build/llm-docs/api/payments/route.md#business-category).

    `subcategory`
    : `string` The business sub-category of the account holder. For example, `clinic`. Possible values: [Business Sub-Category](https://razorpay.com/docs/build/llm-docs/api/payments/route.md#business-sub-category).
