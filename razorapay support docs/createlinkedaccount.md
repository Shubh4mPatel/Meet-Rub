...
```bash: CLI
razorpay route accounts create \
  --email merchant@example.com \
  --phone 9876543210 \
  --legal-business-name "Acme Pvt Ltd" \
  --business-type route \
  --contact-name "Jane Doe" \
  --customer-facing-business-name "Acme Store" \
  --profile-category financial_services \
  --profile-subcategory accounting \
  --profile-business-model "Online marketplace for services" \
  --registered-street1 "12 Main St" \
  --registered-street2 "Floor 2" \
  --registered-city Mumbai \
  --registered-state Maharashtra \
  --registered-postal-code 400001 \
  --registered-country IN \
  --pan AAAPL1234C \
  --gst 29ABCDE1234F1Z5 \
  --website https://acme.example.com \
  --support-email support@acme.example.com \
  --support-phone 9876543210 \
  --note internal_id=acme_001
```
...
: `string` The type of business operated by the Linked Account holder. List of possible values are available [here](https://razorpay.com/docs/build/llm-docs/payments/route/integration-guide.md#business-type).
...
: `object` The business details of the Linked Account's account.
    ...
    : `string` The business category of the Linked Account. Possible values: [List of Business Categories](https://razorpay.com/docs/build/llm-docs/payments/route/integration-guide.md#business-category).

    `subcategory` _mandatory_
    : `string` The business sub-category of the Linked Account. Possible values: [List of Business Sub-Categories](https://razorpay.com/docs/build/llm-docs/payments/route/integration-guide.md#business-sub-category).
...
: `object` The legal details about the Linked Account's business. The mandatory [KYC requirement](https://razorpay.com/docs/build/llm-docs/payments/route/integration-guide.md#kyc-requirements) parameters should be passed depending on the business requirements.
...
`business_type`
: `string` The type of business operated by the account holder. Possible values: [Business Types](https://razorpay.com/docs/build/llm-docs/payments/route/integration-guide.md#business-type). 

`profile`
: `object` The account holder's business details.

    `category`
    : `string` The business category of the account holder. For example, `healthcare`. Possible values: [Business Category](https://razorpay.com/docs/build/llm-docs/payments/route/integration-guide.md#business-category).

    `subcategory`
    : `string` The business sub-category of the account holder. For example, `clinic`. Possible values: [Business Sub-Category](https://razorpay.com/docs/build/llm-docs/payments/route/integration-guide.md#business-sub-category).
...
`legal_info`
: `object` The legal details about the account holder's business. The mandatory [KYC requirement](https://razorpay.com/docs/build/llm-docs/payments/route/integration-guide.md#kyc-requirements) parameters should be passed depending on the business requirements.
