...
: `object` The business details of the Linked Account's account.
    ...
    : `string` The business category of the Linked Account. Possible values: [List of Business Categories](https://razorpay.com/docs/build/llm-docs/api/payments/route.md).

    `subcategory` _mandatory_
    : `string` The business sub-category of the Linked Account. Possible values: [List of Business Sub-Categories](https://razorpay.com/docs/build/llm-docs/api/payments/route.md).
...
`business_type`
: `string` The type of business operated by the account holder. Possible values: [Business Types](https://razorpay.com/docs/build/llm-docs/api/payments/route.md). 

`profile`
: `object` The account holder's business details.

    `category`
    : `string` The business category of the account holder. For example, `healthcare`. Possible values: [Business Category](https://razorpay.com/docs/build/llm-docs/api/payments/route.md).

    `subcategory`
    : `string` The business sub-category of the account holder. For example, `clinic`. Possible values: [Business Sub-Category](https://razorpay.com/docs/build/llm-docs/api/payments/route.md).
...
`legal_info`
: `object` The legal details about the account holder's business. The mandatory [KYC requirement](https://razorpay.com/docs/build/llm-docs/api/payments/route.md) parameters should be passed depending on the business requirements.
