...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    user: process.env.SILVER_EMAIL_SERVER_USER,
    pass: process.env.SILVER_EMAIL_SERVER_PASSWORD,
  },
});

const sendMail = async (to, subject, html, pdfAttachment = null) => {
  const mailOptions = {
    from: process.env.SILVER_EMAIL_FROM,
    to,
    subject,
    html,
  };
...
module.exports = { sendMail, sendBatchMail };
