  ...
  try {
    ...
    if (type === "email-verification") {
      ...
      const { rows: newUserResChatGMP } = await query(
        "INSERT INTO user_data (email, role_id, password, name, gender, isdeleted, credit_id,user_location,created_at) VALUES ($1, $2, $3, $4, $5, $6, $7,$8,$9) RETURNING id, email, name, gender, credit_id",
