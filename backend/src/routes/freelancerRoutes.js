...
const { getMyPayouts, getEarningsBalance, requestPayout, getWalletDashboard, getTransactionHistory } = require('../controller/razor-pay-controllers/freelancerController');
