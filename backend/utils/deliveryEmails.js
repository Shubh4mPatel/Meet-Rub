...
async function sendDeliveryReceivedEmail({
  ...
  const filled = fillTemplate(html, {
    ...
    approve_url:        `${APP_URL}/creator/orders/${projectId}/approve`,
    revision_url:       `${APP_URL}/creator/orders/${projectId}/revision`,
    dispute_url:        `${APP_URL}/creator/orders/${projectId}/dispute`,
    review_days:        REVIEW_DAYS,
    logo_url:           LOGO_URL,
    help_url:           HELP_URL,
    privacy_url:        PRIVACY_URL,
